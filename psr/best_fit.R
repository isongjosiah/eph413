...
phenotype <- read.table("./data/EUR/EUR.height", header=T)
# Read in the PCs
...
covariate <- read.table("./data/EUR/EUR.cov", header=T)
# Now merge the files
...
# You can also print the best result to the screen to see it
print(best.prs.result)
q() # exit R
