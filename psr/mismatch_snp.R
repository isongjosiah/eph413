...
bim[complement.snps,]$B.A2 <-
    sapply(bim[complement.snps,]$B.A2, complement)dat <- read.tabledat <- read.table("EUR.QC.het", header=T) # Read in the EUR.het file, specify it has header
